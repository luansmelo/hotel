...
export default (router: Router): void => {
  ...
  menuRouter.get("/:menuId/category/:categoryId/weekDay/:weekDay", adaptMiddleware(makeAuthMiddleware()), adaptRoute(makeFindMenuController()));
  ...
  // Admin Routes
  menuRouter.post("/", adaptMiddleware(makeAuthAdminMiddleware()), adaptRoute(makeCreateMenuController()));
